...
enum class DictionaryType(private val nameRes: Int, private val descRes: Int)
{
    ...
    {
        return c.resources.getString(nameRes)
    }

    fun getDesc(c: Context): String
    {
        return c.resources.getString(descRes)
    }
