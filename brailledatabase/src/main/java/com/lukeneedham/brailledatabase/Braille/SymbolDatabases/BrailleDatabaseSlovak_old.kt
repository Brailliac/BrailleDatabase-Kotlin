...
object BrailleDatabaseSlovak_old : BrailleDatabase()
{
...
/**
    ...
    override val symbols = listOf(
            ...
            BrailleSymbolDatabaseEntry.LegacyConstructor("ä", LETTER, NOTHING, Cell4),
            ...
            BrailleSymbolDatabaseEntry.LegacyConstructor("ĺ", LETTER, NOTHING, Cell46),
            BrailleSymbolDatabaseEntry.LegacyConstructor("ľ", LETTER, NOTHING, Cell456),
            ...
            BrailleSymbolDatabaseEntry.LegacyConstructor("ô", LETTER, NOTHING, Cell23456), // [23456]
            BrailleSymbolDatabaseEntry.LegacyConstructor("ŕ", LETTER, NOTHING, Cell12356),
            ...
            BrailleSymbolDatabaseEntry.LegacyConstructor("”", R.string.braille_closequote, PUNCTUATION, SHOW_LETTERS_REP, Cell2356), // [56] quote sign, also used for second and inch//BrailleSymbolDatabaseEntry.Companion.LegacyConstructor(NO_STRING, R.string.braille_lettersign, PUNCTUATION, SHOW_INFO, Cell5).setExtraInfo(R.string.lettersignExplanation),// [5]
            ...
            //BrailleSymbolDatabaseEntry.Companion.LegacyConstructor(NO_STRING, R.string.braille_capitalword, PUNCTUATION, SHOW_INFO, Cell56).setExtraInfo(R.string.capitalwordExplanation), // [56]
            ...
            BrailleSymbolDatabaseEntry.LegacyConstructor("&", R.string.braille_pipe, PUNCTUATION, SHOW_LETTERS_REP, Cell3456, Cell12346),
            BrailleSymbolDatabaseEntry.LegacyConstructor("/", R.string.braille_slash, PUNCTUATION, SHOW_LETTERS_REP, Cell12456),
            BrailleSymbolDatabaseEntry.LegacyConstructor("@", R.string.braille_slash, PUNCTUATION, SHOW_LETTERS_REP, Cell4))
}
*/
